...
public class CRFDriver
{
                            ...
                            boolean connected, int iterations, double var, CRF crf)
    {
        ...
        if (numThreads.value > 1) {
            ...
            if (featureInductionOption.value) {
                crft.trainWithFeatureInduction(training, null, testing, eval[0], iterations, 10, 20, 500, 0.5, false, null);
            } else {
                boolean converged;
                for (int i = 1; i <= iterations; i++) {
                    converged = crft.train (training, 1);
    ...
    {
        for (int q = 0; q < eval.length; q++)
            eval[q].evaluateInstanceList(tt, testing, "Testing");
    }
    ...
    public static void main (String[] args) throws Exception
    {
        ...
        if (testOption.value != null)
        {
            ...
            }else if (testOption.value.startsWith("seg="))
            {
                ...
                eval[0] = new MultiSegmentationEvaluator(new InstanceList[] {trainingData, testData}, new String[] {"Training", "Testing"},
