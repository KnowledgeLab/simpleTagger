...
public class PipeTest {
    ...
    public PipeTest(String trainingFilename) throws IOException {
        ...
        pipes.add(new NewSimpleTaggerSentence2TokenSequence());
        //pipes.add(new FeaturesInWindow("PREV-", -1, 1));
        //pipes.add(new FeaturesInWindow("NEXT-", 1, 2));
        pipes.add(new NewTokenTextCharSuffix("POS=", 5));
        //pipes.add(new TokenTextCharSuffix("C2=", 2));
        //pipes.add(new TokenTextCharSuffix("C3=", 3));

        pipes.add(new TokenSequence2FeatureVectorSequence());
        pipes.add(new NewSequencePrintingPipe(out));
    ...
    public static void main (String[] args) throws Exception {
        PipeTest trainer = new PipeTest(args[0]);
